...
- Exact wording of the grounded prompt (discuss in §2)
- What format to use for the refusal marker (`[REFUSE]` / `<refuse/>` / a natural-language sentence)
- Initial values for temperature and top_p
- If Qwen vs Qwen-Coder differ only slightly, which to default to in v2
- Whether you will do all human scoring of the eval queries yourself or split it as a collaboration
